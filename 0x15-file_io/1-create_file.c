...
/**
  * create_file - Starts to create a file with rw------- permissions
  * @filename: Specifies name of the file, if NULL, return -1
  * @text_content: Specifies contents of the file. If NULL, create an empty file
